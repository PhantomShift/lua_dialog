...
function zenity.calendar(text: string, day: number?, month: number?, year: number?, format: string?, options: ZenityOptions?) : string?
...
function zenity.entry(text: string, init: string?, hide: boolean?, options: ZenityOptions?) : string?
    ...
    if hide then table.insert(args, "--hide-text") end
...
function zenityTextInfoBox(command: string, text: string, icon: string?, info_options: {no_wrap: boolean, no_markup: boolean, ellipsize: boolean}?, options: ZenityOptions?)
...
function zenity.error(text: string, icon: string?, info_options: {no_wrap: boolean, no_markup: boolean, ellipsize: boolean}?, options: ZenityOptions?)
    return zenityTextInfoBox("--error", text, icon, info_options, options)
end

function zenity.info(text: string, icon: string?, info_options: {no_wrap: boolean, no_markup: boolean, ellipsize: boolean}?, options: ZenityOptions?)
    return zenityTextInfoBox("--info", text, icon, info_options, options)
end

function zenity.warning(text: string, icon: string?, info_options: {no_wrap: boolean, no_markup: boolean, ellipsize: boolean}?, options: ZenityOptions?)
    return zenityTextInfoBox("--warning", text, icon, info_options, options)
end

--- Returns `true` if user selected "Ok" button
function zenity.question(text: string, icon: string?, info_options: {no_wrap: boolean, no_markup: boolean, ellipsize: boolean}?, options: ZenityOptions?)
    return zenityTextInfoBox("--question", text, icon, info_options, options)
end

function zenity.fileSelection(default: string?, filter: {string}?, selection_options: {multiple: boolean?, directory: boolean?, save: boolean?, separator: string?,}?, options: ZenityOptions?) : string?
...
function zenity.list(text: string, list_type: "checklist" | "radiolist" | "imagelist", headers: {string}, entries: {{string}}, list_options: ZenityListOptions?, options: ZenityOptions?) : string?
...
function zenity.scale(text: string, min: number, max: number, step: number, default: number?, options: ZenityOptions?) : number?
    local args = {
        "--scale", "--text", text,
        "--min-value", tostring(min),
...
function zenity.textInfo(info_options: {filename: string?, editable: boolean?, font: string?, checkbox: string?, auto_scroll: string?}?, options: ZenityOptions?) : string?
